...
def mape_loss(predictions, targets, epsilon=1e-16):
    """
...
def compute_average_relative_error(predictions, labels):
    ...
    return torch.mean(torch.abs(predictions - labels) / (labels + 1e-16)).item()
...
def main():
    ...
    file_path = r"C:\PhD\line_2024\test_overall_1.mat" # Replace with the actual path to your .mat dataset
